...
using ELFinder.Connector.ImageProcessor.Processors;

namespace ELFinder.Connector.ImageProcessor
{
    #region Using
    ...
    public class ImageFactory : IDisposable
    {
        ...
        #region Destructors
        /// <summary>
        /// Finalizes an instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory">ImageFactory</see> class. 
        /// </summary>
        /// <remarks>
        ...
        /// </param>
        /// <returns>
        /// The current instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory"/> class.
        /// </returns>
        ...
        /// The <see cref="T:ELFinder.Connector.ImageProcessor.Imaging.RotateLayer"/> containing the properties to rotate the image.
        /// </param>
        /// <returns>
        /// The current instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory"/> class.
        /// </returns>
        ...
        /// The <see cref="T:ELFinder.Connector.ImageProcessor.Imaging.RoundedCornerLayer"/> containing the properties to round corners on the image.
        /// </param>
        /// <returns>
        /// The current instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory"/> class.
        /// </returns>
        ...
        /// The <see cref="T:ELFinder.Connector.ImageProcessor.Imaging.TextLayer"/> containing the properties necessary to add 
        ...
        /// <summary>
        /// Uses the <see cref="T:ELFinder.Connector.ImageProcessor.Imaging.ColorQuantizer"/>
