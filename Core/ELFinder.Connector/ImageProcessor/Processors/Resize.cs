...
using ELFinder.Connector.ImageProcessor.Helpers.Extensions;

namespace ELFinder.Connector.ImageProcessor.Processors
{
    #region Using
    ...
    public class Resize : IGraphicsProcessor
    {
        ...
        /// </summary>
        /// <param name="factory">
        /// The the current instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory"/> class containing
        /// the image to process.
        /// </param>
        /// <returns>
        /// The processed image from the current instance of the <see cref="T:ELFinder.Connector.ImageProcessor.ImageFactory"/> class.
        /// </returns>
