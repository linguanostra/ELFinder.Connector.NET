...
namespace ELFinder.WebServer.Nancy.Modules
{
    ...
    /// </summary>
    public class ELFinderConnectorModule : NancyModule
    {
        ...
        /// </summary>
        public ELFinderConnectorModule()
        {
        ...
        public ELFinderConnectorModule(string modulePath) : base(modulePath)
        {
        ...
        protected void InitDriver()
        {
            ...
            // Create driver (Refer to Global.asax.cs for shared ELFinder configuration assignment)
        ...
        protected void RegisterGETConnectorRoute<TCommand>(string commandName)
        ...
        protected void RegisterGETConnectorRoute<TCommand>(string commandName, Func<NancyContext, bool> condition)
            where TCommand : IConnectorCommand
        {
        ...
        /// </summary>
        /// <param name="commandName">Command name</param>
        protected void RegisterGETFileDownloadConnectorRoute<TCommand>(string commandName)
        ...
        /// <param name="commandName">Command name</param>
        protected void RegisterPOSTConnectorRoute<TCommand>(string commandName)
            where TCommand : IConnectorCommand
        {
        ...
        /// </summary>
        /// <param name="commandName">Command name</param>
        protected void RegisterPOSTUploadFilesConnectorRoute<TCommand>(string commandName)
        ...
        protected dynamic ConnectorRouteHandler<TCommand>(Func<TCommand, dynamic> executeCommandHandler)
            where TCommand : IConnectorCommand
        {
        ...
        protected dynamic ExecuteCommand<TCommand>(TCommand command)
            where TCommand : IConnectorCommand
        {
        ...
        /// <param name="command">Command</param>
        /// <returns>Result</returns>
        protected dynamic ExecuteFileDownloadCommand<TCommand>(TCommand command)
            where TCommand : ConnectorFileCommand
        {
        ...
        /// <param name="command">Command</param>
        /// <returns>Result</returns>
        protected dynamic ExecuteGetThumbnailCommand<TCommand>(TCommand command)
